...
final class AuthenticateUseCase {
    ...
    ///   - nickname: 변경할 닉네임
    /// - Returns: User 혹은 Error 를 발행하는 Publisher
    func changeNickname(_ user: User, to nickname: String) -> AnyPublisher<User, Error> {
    ...
    /// - Returns: User 혹은 Error 를 발행하는 Publisher
    func changeProfileImage(_ user: User, to imageData: Data) -> AnyPublisher<User, Error> {
